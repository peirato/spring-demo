...
public class CustomerRunner implements ApplicationRunner {
    ...
    private void showServiceInstances() {
        ...
        discoveryClient.getInstances("waiter-service").forEach(serviceInstance -> {
    ...
    private Long orderCoffee() {
        NewOrderRequest orderRequest = NewOrderRequest.builder()
                ...
                .build();
        RequestEntity<NewOrderRequest> request = RequestEntity.post(
                UriComponentsBuilder.fromUriString("http://waiter-service/order/")
                        .build()
                        .toUri())
                .body(orderRequest);

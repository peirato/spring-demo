package peirato.spring.springbucks.customer.support;
...
public class CircuitBreakerAspect {
    ...
    @Around("execution(* peirato.spring.springbucks.customer.integration..*(..))")
    public Object doWithCircuitBreaker(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            log.warn("Circuit breaker counter: {}, Throwable {}",
                    counter.get(signature).incrementAndGet(), throwable.getMessage());
            breakCounter.get(signature).set(0);
            throw throwable;
        }
